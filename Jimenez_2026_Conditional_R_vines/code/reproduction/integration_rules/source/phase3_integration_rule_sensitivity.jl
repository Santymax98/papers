...
include(joinpath(@__DIR__, "..", "..", "benchmarks", "publication", "publication_common.jl"))

const OUTDIR = @__DIR__
const FROZEN = joinpath(@__DIR__, "..", "..", "benchmarks", "results", "publication", "final_01_COMPLETE_CHECKPOINT")
